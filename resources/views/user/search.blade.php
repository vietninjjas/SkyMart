            ...
            <div class="col-lg-3 box-pro-1">
                <div class="box-product-left">
                    ...
                    <div class="pro-cate">
                        ...
                        <ul class="pro-star">
                            <li><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i> <span>(Từ 5 sao)</span></li>
                            <li><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i> <span>(Từ 4 sao)</span></li>
                            <li><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i> <span>(Từ 3 sao)</span></li>
                        </ul>
                    </div>
                    <div class="pro-cate">
                        <div class="pro-title">
