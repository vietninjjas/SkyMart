                                    ...
                                    <div class="lon">
                                        <div class="cac">
                                            @foreach ($cate->children as $catehihi)
                                                <ul>
                                                    <h5>
                                                        <a href="{{ route('category.show', $catehihi->cate_id) }}">
                                                            {{ $catehihi->cate_name }}
                                                        </a>
                                                    </h5>
                ...
                <div id="gallery">
                    @foreach ($categories as $cate)
                        @if ($cate->parent_id != null)
                            <div class="pro-hov">
                                <div class="product-top">
                                    <img src="images/categories/cate_images/{{ $cate->cate_image }}" alt="">
                                </div>
                                <div class="product-bottom text-center">
                        ...
                        @foreach ($hots as $hot)
                            <div class="col-md-3 pro-hov">
                                <div class="product-top">
                                    ...
                                    <div class="overlay">
                                        <a href="{{ route('product.show', $hot->pro_id) }}" class="btn btn-secondary"
                                            title="{{ trans('main.product.detail') }}">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <form action="" method="post">
                                            <button type="button" class="btn btn-secondary"
                                                title="{{ trans('main.product.add_wishlist') }}">
                                                <i class="fa fa-heart"></i>
                                            </button>
                                        </form>
                                        <form action="{{ route('addCart') }}" method="post">
                                            ...
                                            <button type="submit" class="btn btn-secondary"
                                                title="{{ trans('main.product.add_cart') }}">
                                                <i class="fa fa-shopping-cart"></i>
                                            </button>
                                        </form>
                                    </div>
